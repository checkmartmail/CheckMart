...
function ctype(present_array) {
  ...
  for (var j = 0; j < total_present_div_products; j++) {
    ...
    products_div_elements += `<a href="/checkmart%20products.html?value=` + present_div_product + `"><img class="direct_image" src="` + present_div_product_thumbnail + `" alt=""  loading="lazy"></a>`;
